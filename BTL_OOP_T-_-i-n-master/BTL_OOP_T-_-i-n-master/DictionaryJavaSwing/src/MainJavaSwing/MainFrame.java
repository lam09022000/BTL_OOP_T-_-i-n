...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SearchLayout.setHorizontalGroup(
            ...
            .addGroup(SearchLayout.createSequentialGroup()
                .addGroup(SearchLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(SearchLayout.createSequentialGroup()
                        .addComponent(languageSearch_JLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 97, Short.MAX_VALUE)
        ...
        soundUS_Defi_JButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                soundUS_Defi_JButtonActionPerformed(evt);
            }
        });
    ...
    //click chuot vao tung tu sau khi tim kiem
    ...
    private void setFrameDefi(Word word) {
        ...
        //REVI
        word__InputEdit_JTextField.setText(word.getWordTarget());
        spelling__InputEdit_JTextField.setText(word.getWordSpelling());
        translate_InputEdit_JTextArea.setText(word.getWordExplain());
    ...
    private void submit_Edit_JButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submit_Edit_JButtonActionPerformed
        ...
        if (ans == JOptionPane.YES_OPTION) {
            ...
            Word newWord = new Word(word__InputEdit_JTextField.getText(),
                    spelling__InputEdit_JTextField.getText(),
                    translate_InputEdit_JTextArea.getText()) ;
    ...
    private void submit_Add_JButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submit_Add_JButtonActionPerformed
        ...
        if (ans == JOptionPane.YES_OPTION) {
            // neu dong y thi them tu
            String wordEN = word_InputAdd_JTextField.getText() ;
            String wordVN = translate_InputAdd_jTextArea.getText() ;
            String spelling = "" ;
    ...
    private void soundUS_Defi_JButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_soundUS_Defi_JButtonActionPerformed
        System.out.println("am thanh");
        String link = "C:\\Users\\doxua\\OneDrive\\Desktop\\BTL_OOP_T-_-i-n-master\\BTL_OOP_T-_-i-n-master\\DictionaryJavaSwing\\src\\MainJavaSwing\\Sound\\" ;
        if(nowWord.getSound_EN() != "noSound") {
            try {
                AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File(link + nowWord.getSound_EN()).getAbsoluteFile());
    ...
    }//GEN-LAST:event_soundUS_Defi_JButtonActionPerformed

    private void listResultHistory_JListMouseClicked(java.awt.event.MouseEvent evt) {                                                     
        // history
        if (listResultHistory_JList.getSelectedIndex() !=  -1) {
            String resultSearch = listResultHistory_JList.getSelectedValue();
        }
        nowWord = historyWord.get( historyWord.size() - listResultHistory_JList.getSelectedIndex() - 1) ;
        setFrameDefi(nowWord);
    }
